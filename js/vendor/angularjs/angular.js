...
function setupModuleLoader(window) {
  ...
  return ensure(angular, 'module', function() {
     ...
     * searchApp.value('appName', 'MyCoolApp');
     *
     ...
     *
     * ```js
     * var injector = angular.injector(['ng', 'searchApp'])
     * ```
     *
 ...
 *
 * ```js
 *   var searchApp = angular.module(...);
 *
 *   searchApp.directive('directiveName', function factory(injectables) {
